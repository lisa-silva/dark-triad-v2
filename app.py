...
questions = [
    ...
    "Public Scapegoat: Does he joke about your 'failure' in public? Use your name to booking tee times—then no-show and trash your rep?",
    ...
    "Freeloader Flip: Does he expect you to pay his golf and lunch when broke—then cut you off cold the second he's paid? 'Fuck off, you\'re not my kid'?",
